...
export function UserMenuDropdown({
	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent
				className="w-[calc(100vw-3rem)] md:w-70 rounded-2xl bg-white/60 dark:bg-black/40 backdrop-blur-3xl border-foreground/10 shadow-2xl shadow-muted-foreground/50 p-2 z-50 ml-1 mb-1 md:mb-8"
				align={align}
				side={side}
				sideOffset={8}
			>
