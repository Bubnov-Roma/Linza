...
const steps = [
	{
		...
		title: "Поиск",
		desc: "Найдите технику через поиск или в каталоге. Используйте фильтры по категориям",
	},
	{
		icon: CalendarCheckIcon,
		title: "Бронирование",
		desc: "Добавьте выбранную технику в корзину или оформите заказ прямо со страницы товара.",
	},
	{
		icon: FileTextIcon,
		title: "Анкета",
