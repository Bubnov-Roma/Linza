	...
	return (
		<DrawerPortal data-slot="drawer-portal">
			...
			<DrawerPrimitive.Content
				...
				className={cn(
					"group/drawer-content bg-background/60 fixed z-75 flex h-auto flex-col backdrop-blur-lg",
				...
				{...props}
			>
				<div className="bg-muted-foreground mx-auto mt-0 hidden h-2 w-25 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
				{children}
			</DrawerPrimitive.Content>
		</DrawerPortal>
	);
