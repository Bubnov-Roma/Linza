	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					"bg-background/10 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 backdrop-blur-xl",
					side === "right" &&
