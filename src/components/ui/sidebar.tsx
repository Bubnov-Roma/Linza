...
function Sidebar({
	...
	return (
		<div
			...
			data-slot="sidebar"
		>
			{/* Gap element that controls layout shift */}
			<div
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			className={cn(
				"bg-transparent hover:after:bg-sidebar absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-0.5 sm:flex",
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			data-sidebar="header"
			className={cn(
				"flex flex-col gap-2 p-2 bg-transparent backdrop-blur-2xl",
				className
			)}
			{...props}
		/>
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"flex min-h-0 flex-1 flex-col gap-2 overflow-auto overflow-y-auto overflow-x-hidden",
				className
			)}
			{...props}
		/>
