...
export const STATUS_STEPS: {
	...
	},
	{
		key: "WAIT_PAYMENT",
		label: "Оплата",
		desc: "Ожидается внесение предоплаты",
	},
	{
		key: "READY_TO_RENT",
		label: "Выдача",
		desc: "Заказ готов к аренде",
	},
	{
		key: "ACTIVE",
		label: "Аренда",
		desc: "Заказ находится в аренде",
	},
...
export const CANCELLATION_PRESETS = [
	"Отменилась съёмка или изменилась дата",
	"Нужное для меня время было занято",
	"Нашлось дешевле в другом месте",
